  ...
  return (
    <div className="overflow-x-auto overflow-y-hidden text-accent text-xs lg:text-base">
      ...
      <div className="bg-primary/40 flex flex-col items-center justify-center p-6  md:p-10 rounded-xl min-h-[calc(100vh-430px)] gap-2 text-center mx-auto">
        ...
        <h2 className="text-2xl md:text-4xl font-semibold text-secondary">No Tips Added</h2>
        <p >Please go back the Share a Garden Tips page and add a garden Tips</p>
      </div>
      }
    </div>
  );
