...
const Error = () => {
    return (
        <div className='flex flex-col justify-center items-center min-h-screen bg-white text-secondary-content'>
            ...
            <Link to='/' className='btn bg-secondary-content text-white hover:bg-white hover:text-secondary-content hover:border-secondary-content transition-all duration-500'>Go Back Home</Link>
        </div>
    );
};
